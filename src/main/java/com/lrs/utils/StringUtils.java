...
* provided by the mvc Java {@link String} and {@link StringBuilder}
...
public abstract class StringUtils {
    ...
    public static String cleanPath(String path) {
        ...
        // "file:mvc/../mvc/io/Resource.class", where the ".." should just
        // strip the first "mvc" directory while keeping the "file:" prefix.
